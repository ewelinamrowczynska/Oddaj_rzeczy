...
<div className="nav_container">
        ...
        <ul className="menu">
            <li className="menu_el"><Link to="/">Start</Link></li>
            <li className="menu_el"><Link to="/what-about">O co chodzi?</Link></li>
            <li className="menu_el"><Link to="/about-us">O nas</Link></li>
